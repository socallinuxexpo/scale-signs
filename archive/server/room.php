...
$sponsors = array(
    ...
    "bitergia"                          =>    "bitergia.png",
    "ceph"                              =>    "ceph.png",
    "chaossearch"                       =>    "chaossearch.png",
    "chef"                              =>    "chef.png",
    "cirro"                             =>    "cirro.png",
    ...
    "twilio"                            =>    "twilio.png",
    "ubuntu"                            =>    "ubuntu.jpg",
    "uclalawschool"                     =>    "uclalawschool.png",
    "uncoded"                           =>    "uncoded.png",
    "usenix"                            =>    "usenix.png",
    "verizon"                           =>    "verizon.png",
    ...
    "westernregional"                   =>    "westernregionalcyberdefense.png",
...
$diamond_platinum_sponsors = array("microsoft");
...
$sponsors_to_rooms = array(
    ...
    "ballroom-de"   => array(
            "Thursday"  => array(),
            "Friday"    => array("appd","confluent","code_fresh","d2iq","datree","effx","gitlab","harness","influx","launchdarkly","logz","phoenixnap","pulumi","site247","sonatype","splunk","spotinst","xmatters"),
            "Saturday"  => array(),
            "Sunday"    => array(),
    ),
    "ballroom-f"    => array(
