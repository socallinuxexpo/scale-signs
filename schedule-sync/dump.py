...
sched_org_url = "http://scale16x2017.sched.org/api"
...
def main():
    ...
    schedule_xml = "https://www.socallinuxexpo.org/scale/16x/sign.xml"
    dom = download_schedule("http://www.socallinuxexpo.org/scale/16x/sign.xml")
