<?php
  ...
  $carousel_one = array(
    0 => array("name" => 'Current Wi-Fi associations', "graph" => "gateway-2.expo.socallinuxexpo.org-2-day.png" ),
    1 => array("name" => 'Total Wi-Fi associations', "graph" => "combinded-6hourly.png" ),
    );
